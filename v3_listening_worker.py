"""
    ...
    The "." is the measurement of time for the message to be received. 
    Because of this "limiter", the user should received certain messages in an order based on the # of "." behind a csv task. 
...
# define a callback function to be called when a message is received - Updated NV
